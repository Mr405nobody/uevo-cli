...
Your authentication method refers to the method you use to log into and access the Gemini CLI. There are two ways to authenticate:

- Logging in with your Google account to Gemini Code Assist (Individuals, Workspace, Standard, or Enterprise)
- Using an API key with the Gemini Developer API

For each of these methods of authentication, different Terms of Service and Privacy Notices may apply.
